...
const Package = () => {
    ...
    //     setFranchises(packagesList.filter((pkg: any) => pkg.franchiseName === 'Franchise'));
    //     setsignals(packagesList.filter((pkg: any) => pkg.franchiseName === 'Signals'));
    //     setCourses(packagesList.filter((pkg: any) => pkg.franchiseName === 'Courses'));
    // }
                ...
                <div>
                    ...
                    {packagesList?.length > 0 ? (
                        packagesList?.map((pkg: any) => (
                            <div key={pkg?._id} className="max-w-[600px] flex justify-between min-h-[80px] bg-primary rounded-3xl p-5 mb-2">
