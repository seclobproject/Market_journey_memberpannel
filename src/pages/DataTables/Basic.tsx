...
const Basic = () => {
    ...
    return (
        <div>
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 text-base bg-primary text-white ml-auto w-fit">
                Add Member
            </div>
            <div className="panel mt-6">
                <h5 className="font-semibold text-lg dark:text-white-light mb-5">Member</h5>
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'Ditrict', title: 'district' },
                            { accessor: ' constituency' },
                            { accessor: ' Panjayathe' },
                            // { accessor: '  franchise' },
                            // { accessor: ' subfranchise' },
                            // { accessor: ' Mobilefranchise' },
                            // { accessor: ' Renuvalfranchise' },
                            { accessor: ' zoonfranchise' },
                            { accessor: '  Pakage amt' },
                        ]}
